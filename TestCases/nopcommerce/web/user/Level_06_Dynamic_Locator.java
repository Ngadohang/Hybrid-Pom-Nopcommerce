...
public class Level_06_Dynamic_Locator extends AbstractTest {
	...
	public void TC_04_Switch_Page() {
		addressPage=(AddressesPageObject) customerInfor.openNewPage(driver, "Addresses");
		orderPage= (OrderPageObject) addressPage.openNewPage(driver, "Orders");
		dowloadablePage= (DownloadablePageObject) orderPage.openNewPage(driver, "Downloadable products");
		backInStock=(BackInStockPageObject) dowloadablePage.openNewPage(driver, "Back in stock subscriptions");
		rewardPoint=(RewardPointPageObject) backInStock.openNewPage(driver, "Reward points");
		changePassword=(ChangePasswordPageOject) rewardPoint.openNewPage(driver, "Change password");
		myProduct=(MyProductReviewPageObject) changePassword.openNewPage(driver, "myProduct");
	}
